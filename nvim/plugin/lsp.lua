...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(args)
        ...
        print("LSP: " .. client.name .. " attached to buffer " .. args.buf)
        local buf    = args.buf
...
local caps = status_cmp_lsp and cmp_lsp.default_capabilities() or {}
...
vim.lsp.config['pyright'] = {
    ...
    filetypes = { 'python' },
    root_markers = { 'pyrightconfig.json', 'pyproject.toml', 'requirements.txt', 'setup.py', 'setup.cfg', '.git' },
    capabilities = caps,
}
